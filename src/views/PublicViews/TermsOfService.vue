...
<template>
  <div>
    ...
    <p>
      The following Terms of Use are entered into by and between You and Simple
      City Software LLC (“<strong>Company</strong>”, “<strong>we</strong>”, or
      “<strong>us</strong>”).
    </p>
    <p>
      The following terms and conditions, together with any documents they
      expressly incorporate by reference (collectively, these “<strong
        >Terms of Use</strong
      >”), govern your access to and use of www.spindj.io, including any
      content, functionality and services offered on or through www.spindj.io
    ...
    <p>
      ...
      agree to be bound and abide by these Terms of Use and our Privacy Policy,
    ...
    <p>
      ...
      on the Website, is the property of the Company or its suppliers and
    ...
    <p>
      ...
      of the content, in whole or in part, found on the Website or any of the
      resources available for download from the Website.
    </p>
    <p>
      ...
      in any content. You will use protected content solely for your individual
    ...
    <p>
      As set forth more fully in the Disclaimer, the information contained on
      this Website and the resources available for download through this Website
      are for educational and informational purposes only. The information
      contained on this Website and the resources available for download through
      this Website is not intended as, and shall not be understood or construed
      as legal, financial, tax, medical, health, or any other professional
      advice.
    </p>
    ...
    <p>
      ...
      its owners or employees shall be held liable or responsible for any errors
      or omissions on this Website or for any damage you may suffer as a result
      of failing to seek competent advice from a professional who is familiar
      with your situation.
    </p>
    <p>
      By using this Website, you accept personal responsibility for the results
      of your actions. You agree to take full responsibility for any harm or
      damage you suffer as a result of the use, or non-use, of the information
    ...
    <p>
      ...
      otherwise - applying the principles set out in this Website are no
      guarantee that you or any other person or entity will be able to obtain
      similar results.
    </p>
    ...
    <p>
      ...
      and on the Website, satisfy any legal requirement that such communications
      be in writing.
    </p>
    <p>
      ...
      Policy, we will take reasonable steps to ensure that any communications
      remain confidential, but we cannot guarantee the security of such
      communications and cannot guarantee that we would not be required to
    ...
    <p>
      ...
      “<strong>Communication Services</strong>”), you agree to use the
    ...
    <p>
      ...
      and publicity) of others; publish, post, upload, distribute or disseminate
      ...
      rights of privacy of publicity) unless you own or control the rights
      thereto or have received all necessary consents; upload files that contain
      viruses, corrupted files, or any other similar software or programs that
      may damage the operation of another's computer; advertise or offer to sell
      ...
      forward surveys, contests, pyramid schemes or chain letters; download any
      ...
      for any particular Communication Service; harvest or otherwise collect
    ...
    <p>
      ...
      about yourself in any Communication Service. The Company does not control
      or endorse the content, messages or information found in any Communication
      Service and, therefore, the Company specifically disclaims any liability
      ...
      not authorized Company spokespersons, and their views do not necessarily
    ...
    <p>
      ...
      Company, our affiliated companies, and necessary sub-licensees permission
      ...
      and reformat your Submission; and to publish your name in connection with
      your Submission.
    </p>
    <p>
    ...
    <p>
      ...
      including without limitation any link contained in a Linked Website, or
      any changes or updates to a Linked Website. The Company is providing these
    ...
    <p></p>
    <h2>Use Of Templates And Forms</h2>
    <p>
      The Company provides various templates and/or forms for download and/or
      sale on this Website. The Company grants you a limited, personal,
      non-exclusive, non-transferable license to use our templates and/or forms
      ...
      alter, enhance or in any way exploit any of the templates and/or forms in
      any manner, except for modifications in filling out the templates and/or
      forms for your authorized use.
    </p>
    <p>
      By ordering or downloading Forms, you agree that the Forms you purchase or
      download may only be used by you for your personal or business use and may
      not be sold or redistributed without the express written consent of the
      Company.
    </p>
    <p></p>
    <p></p>
    ...
    <p>
      Certain of the Company's products and services are offered on an ongoing
      basis with a monthly or yearly subscription. Users may cancel
      subscriptions at any time by emailing admin@simplecitysoftware.com.
    </p>
    <p></p>
    <p>
      Your subscription shall continue until the end of the existing
      subscription period and shall terminate at the completion of that period.
    ...
    <p>
      ...
      OR THROUGH THIS WEBSITE. TO THE FULLEST EXTENT PERMISSIBLE UNDER THE LAW,
    ...
    <p>
      ...
      OR ANY PERSON OR ENTITY ASSOCIATED WITH YOU MAY SUFFER OR INCUR AS A
      RESULT OF USE OF THE INFORMATION CONTAINED ON THIS WEBSITE AND/OR THE
      RESOURCES YOU MAY DOWNLOAD FROM THIS WEBSITE. YOU AGREE THAT THE COMPANY
      SHALL NOT BE LIABLE TO YOU FOR ANY TYPE OF DAMAGES, INCLUDING DIRECT,
      INDIRECT, SPECIAL, INCIDENTAL, EQUITABLE, OR CONSEQUENTIAL LOSS OR DAMAGES
    ...
    <p>
      ...
      OTHERWISE, EVEN IF THE COMPANY OR ANY OF ITS SUPPLIERS HAS BEEN ADVISED OF
    ...
    <p>
      ...
      future, arising out of or relating to this Website, the Company, any and
      all contracts you enter into with the Company, and any and all of the
    ...
    <p>
      ...
      occur in St. Peters<span style="font-weight: 400">, MO</span>. You further
      agree to and do hereby waive any right to class arbitration and agree,
      instead, to conduct an arbitration related solely to any individual claims
      you and/or any entity related to you asserts against the Company. To the
      fullest extent permissible by law, you further agree that you shall be
      responsible for all costs associated with initiating the arbitration and
      for the administration of the arbitration.
    </p>
    <p><span style="font-weight: 400"></span></p>
    ...
    <p>
      ...
      You agree that you will not use the Company Content accessed through the
      Website in any country or in any manner prohibited by any applicable laws,
    ...
    <p>
      ...
      violation of any applicable laws, rules or regulations. The Company
    ...
    <p>
      ...
      this Website or the Terms of Use pursuant to the
      <span style="font-weight: 400"></span>Arbitration<span
        style="font-weight: 400"
      >
        Clause above. Use of the Website is unauthorized in any jurisdiction
        that does not give effect to all provisions of these Terms, including,
        without limitation, this section.</span
      >
    </p>
    ...
    <p>
      ...
      to or gathered by the Company with respect to such use. If any part of
    ...
    <p>
      ...
      Terms under which the Website is offered. The most current version of the
    ...
    <p>
      <span style="font-weight: 400">Simple City Software LLC</span><br />
      <span style="font-weight: 400">5400 Mexico Rd 1337</span><br />
      <span style="font-weight: 400">St. Peters, MO 63376</span>
    </p>
    <p>Email Address: admin@simplecitysoftware.com</p>
    <p>
      Effective as of
      <span
        data-sheets-value='{"1":2,"2":"Jan 20, 2022"}'
        data-sheets-userformat='{"2":6995,"3":{"1":0},"4":[null,2,16777215],"7":{"1":[{"1":2,"2":0,"5":[null,2,0]},{"1":0,"2":0,"3":3},{"1":1,"2":0,"4":3}]},"9":0,"11":4,"12":0,"14":[null,2,2105636],"15":"Roboto, arial, sans-serif"}'
        >Jan 20, 2022</span
      >
    </p>
  </div>

<template>
  <div>
    ...
    <p>
      Simple City Software LLC (“Company,” “we,” or “us”) respects your privacy
      and is committed to protecting it through this Privacy Policy.
    </p>
    <p>
      This Privacy Policy governs your access to and use of www.spindj.io,
      including any content, functionality and services offered on or through
      www.spindj.io (the “Website”), whether as a guest or a registered user.
    </p>
    <p>
      When accessing the Website, the Company will learn certain information
      about you, both automatically and through voluntary actions you may take,
      during your visit. This policy applies to information we collect on the
      Website and in email, text, or other electronic messages between you and
      the Website.
    </p>
    <p>
      ...
      agree to be bound and abide by the Privacy Policy. If you do not want to
      agree to the Privacy Policy, you must not access or use the Website.
    </p>
    ...
    <p>
      ...
      child under 13 without verification of parental consent, we will delete
      that information. If you believe we might have any information from or
      about a child under 13, please contact us at admin@simplecitysoftware.com.
    </p>
    ...
    <p>
      ...
      and/or service, to improve our overall performance, and to provide you
    ...
    <p>
      ...
      unique identifier. When you visit a website, that site's computer asks
      your computer for permission to store this file in a part of your hard
      drive specifically designated for cookies. Each website can send its own
    ...
    <p>
      ...
      reserves the right to use these pixels in compliance with the policies of
    ...
    <p>
      ...
      participation in the activities you select. If you register to download a
      book or resources, sign up for our newsletter, and/or purchase a product
      from us, we collect your information. We use this information to track
      your preferences and to keep you informed about the products and services
      you have selected to receive and any related products and/or services. As
      a visitor to this Website, you can engage in most activities without
      providing any personal information. It is only when you seek to download
      resources and/or register for services that you are required to provide
      information.
    </p>
    <p>
      ...
      webinar, register for a live event, register for a seminar, or purchase
      any products sold by the Company on this Website, we will automatically
      enroll you to receive our free email newsletter. If you do not wish to
      ...
      trouble unsubscribing, you can send an email to
      admin@simplecitysoftware.com requesting to unsubscribe from future emails.
    </p>
    <p>
      If you are in the European Union and opt to receive any free resources,
      participate in any free training programs, register for a webinar,
      register for a live event, register for a seminar, or purchase any
      products sold by the Company on this Website, we will only enroll you to
      receive our free email newsletter if you affirmatively consent to it. If
      you do not wish to receive this newsletter, you can unsubscribe anytime.
      We include an “unsubscribe” link at the bottom of every email we send. If
      you ever have trouble unsubscribing, you can send an email to
      admin@simplecitysoftware.com requesting to unsubscribe from future emails.
    </p>
    ...
    <p>
      ...
      other sale or transfer of some or all of the Company's assets and/or
      business.
    </p>
    <p>
    ...
    <p>
      ...
      automatically. This includes using standard security protocols and working
      only with reputable third-party vendors.
    </p>
    <p>
      ...
      information you may enter on our website may be transmitted securely via a
    ...
    <p>
      ...
      are used for such purposes as assessing the number of visitors to the
      different sections of our site, what information is of most and least
    ...
    <p>
      ...
      the privacy policy was last revised is identified at the bottom of the
    ...
    <p>
      ...
      to cease using our existing data providers, or (c) the Company decides
    ...
    <p>
      ...
      time, without affecting the lawfulness of processing based upon consent
    ...
    <p>
      We require only the information that is reasonably required to enter into
      a contract with you. We will not require you to provide consent for any

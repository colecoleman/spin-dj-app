    ...
    <div class="three-quarter-width" id="scroll-wrapper">
      <base-card id="details-form">
        <div id="middle-section-inner-wrapper">
          <div id="top-wrapper">
            <div id="heading-div">
              <h2>Let's make a new package!</h2>
            </div>
          </div>
          <div id="input-div">
            <form>
      ...
      <base-card id="service-form">
        <div id="service-wrapper">
          <h2>Sweet! Now let's build this out.</h2>
              ...
              <div class="chosen-service-item-info">
                ...
                >
                  <h5>
                    ${{
                      parseInt(
                        getStockItem(service).hourlyPriceOption.baseRate
                      ).toLocaleString()
                    }}
                    for
                    {{ getStockItem(service).hourlyPriceOption.baseTime }}
                    hours
                  </h5>
                  <h5>
                    + ${{
                      parseInt(
                        getStockItem(service).hourlyPriceOption
                ...
                >
                  <h5>
                    ${{
                      parseInt(
                        getStockItem(service).flatRatePriceOption.rate
                      ).toLocaleString()
                    }}, flat rate
                  </h5>
                </div>
              ...
              <div class="chosen-service-item-override">
                <div class="chosen-service-item-override-field">
                  ...
                  <input
                    type="number"
                    :placeholder="service.flatRatePriceOption.rate"
                    v-model="selectedServices[index].additionalEmployees"
                  />
                </div>
              </div>
            </div>
...
export default {
  data() {
    return {
      ...
      fourHourPricePreview: undefined,
      fiveHourPricePreview: undefined,
      sixHourPricePreview: undefined,
      sevenHourPricePreview: undefined,
      eightHourPricePreview: undefined,
  ...
  methods: {
    ...
    getStockItem(service) {
      let matchedItem = this.services.findIndex((x) => x.id === service.id);

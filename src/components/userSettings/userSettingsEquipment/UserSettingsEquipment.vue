...
<template>
  <section>
    <base-card>
      ...
      <div id="heading-div">
        <h2>Equipment</h2>
        <router-link to="addnewequipment"
          ><svg
      ...
      <div id="body-div">
        ...
        >
          ...
          <div class="main">
            ...
            <div class="equipment-item-inner-wrapper">
              <h4>{{ equipment.equipmentName }}</h4>
              <div class="data-container">
                <div>
                  <p># in a set: {{ equipment.setQuantity }}</p>
                  <p># owned: {{ equipment.quantityOwned }}</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="equipment-item">
          <router-link to="addnewequipment" id="add-new-equipment-card">
...
//TODO: MAKE DEFAULT IMAGE FOR EQUIPMENT
...
export default {
  ...
  //   editItem(id) {
  //     console.log(id);
  //     this.$router.push({ name: "editequipment", params: { equipmentid: id } });
  //   },
  //   deleteItem(equipment) {
  //     if (confirm("Are you sure you want to delete?")) {
  //       if (!equipment.photo) {
  //         this.deleteItemFromFirestore(equipment.id);
  //         console.log(equipment.id);
  //         console.log("deleted without photo");
  //       } else if (equipment.photo) {
  //         this.deleteItemFromFirestore(equipment.id);
  //         this.deleteItemFromStorage(equipment.id);
  ...
  //       let equipmentPhotoRef = firebase
  //         .storage()
  //         .ref()
  //         .child("equipment/" + id + ".jpeg");
  //       equipmentPhotoRef
  //         .delete()
  //         .then(() => {
  ...
  //       .then(() => {
  //         console.log("deleted");
  //         const indexToDelete = this.equipment.findIndex((x) => x.id === id);
  //         console.log(indexToDelete);
  //         this.equipment.splice(indexToDelete, 1);
  //       });
  //   },
  // },
  components: { BaseCard },
